 ...
 *
 * <p>- 인증 사용자 기준으로 최신 좋아요 순서대로 반환 - 페이징: offset/limit - SecurityContext의 이메일(username)로 userId 조회
 */
@RestController
@RequestMapping("/me")
...
public class MyLikeController {
    ...
    public List<PostDto> myLikes(
            @Parameter(description = "오프셋(0부터 시작)", example = "0") @RequestParam(defaultValue = "0")
                    int offset,
